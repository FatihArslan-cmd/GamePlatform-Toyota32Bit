...
const BottomSheet = React.forwardRef(({setTheme, theme, setThemeSwitch, themeSwitch}, ref) => {
  ...
  return (
    <>
      <BackDrop close={close} translateY={translateY} openHeight={OPEN} closeHeight={CLOSE} />
      <GestureDetector gesture={pan}>
        <Animated.View
          ...
          <Icon theme={theme} />
          <Animated.Text style={[styles.textTitle, textColorAnimation]}>Choose a style</Animated.Text>
